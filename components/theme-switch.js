...
export default function ThemeSwitch() {
    ...
    useEffect(() => {
        ...
        if (!document.firstElementChild.hasAttribute('data-theme')) {
            ...
            reflectPreference(getThemePreference)
        }
        return () => window.matchMedia('(prefers-color-scheme: dark)').removeEventListener('change', ({ matches: isDark }) => {
            reflectPreference(isDark ? 'dark' : 'light')
        } )
    }, [])
